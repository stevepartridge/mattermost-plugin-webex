...
type configuration struct {
	...
	WebexAuthorizeURL   string
	WebexAccessTokenURL string
	EncryptionKey       string
}

const (
	DefaultAuthorizeURL   = "https://api.ciscospark.com/v1/authorize"
	DefaultAccessTokenURL = "https://api.ciscospark.com/v1/access_token"
)
...
func (p *Plugin) OnConfigurationChange() error {
	...
	// Set the defaults if not present
	if configuration.WebexAuthorizeURL == "" {
		configuration.WebexAuthorizeURL = DefaultAuthorizeURL
	}

	if configuration.WebexAccessTokenURL == "" {
		configuration.WebexAccessTokenURL = DefaultAccessTokenURL
	}
